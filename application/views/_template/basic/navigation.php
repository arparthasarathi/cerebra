<div class="row landing-animate-frame" name="landing-animation-frame-4">
            <nav class="navbar navbar-default">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li><a data-pjax="true" href="<? echo base_url(); ?>events">Events</a></li>

                        <li><a data-pjax="true" href="<? echo base_url(); ?>workshops">Workshops</a></li>

                        <li><a data-pjax="true" href="<? echo base_url(); ?>lectures">Lectures</a></li>

                        <li><a data-pjax="true" href="<? echo base_url(); ?>xceed">XCEED</a></li>

                        <li><a data-pjax="true" href="<? echo base_url(); ?>sponsors">Sponsors</a></li>

                        <li><a data-pjax="true" href="<? echo base_url(); ?>about">About</a></li>

                        <li><a data-pjax="true" href="<? echo base_url(); ?>contact">Contact</a></li>
                    </ul>
        ...
        <div class="row landing-animate-frame" name="landing-animation-frame-4">
            <div class="col-lg-2">
                <h3 class="updates-title">UPDATES <i class="fa fa-angle-double-right" name="animate-arrow"></i></h3>
            </div>
            <div class="col-lg-10">
                <div class="updates-navigation">
                    <div class="row">
                        ...
                        <ul>
                            ...
                            <li><? echo $update['update_content']; ?></li>
                            <? } ?>
                        </ul>
                        </div>
                        <? } ?>
