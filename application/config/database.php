...
$db['cms']['database'] = 'k14_cms';
// $db['cms']['database'] = 'kurukshetra.org.in_cms';
 //$db['cms']['hostname'] = 'database.cms14.kurukshetra.org.in';
 //$db['cms']['username'] = 'k14_admin';
 //$db['cms']['password'] = 'scott_tiger';
 //$db['cms']['database'] = 'k14_cms';
